...
public class PayPalOrdersClient {
    ...
    public PayPalCreateOrderResponse createOrder(BigDecimal amountUsd, String currency,
        ...
        HttpRequest request = HttpRequest.newBuilder()
                .uri(URI.create(props.getBaseUrl() + "/v2/checkout/orders"))
        ...
        try {
            ...
            log.debug("[PayPal] createOrder status={} body={}", response.statusCode(), response.body());
    ...
    public PayPalCaptureResponse captureOrder(String paypalOrderId) {
        ...
        try {
            HttpResponse<String> response = httpClient.send(request, HttpResponse.BodyHandlers.ofString());
            log.debug("[PayPal] captureOrder orderId={} status={} body={}",
