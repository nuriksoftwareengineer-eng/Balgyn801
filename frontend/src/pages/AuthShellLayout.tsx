  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden flex-col bg-black text-white md:flex md:w-[420px] lg:w-[500px]">
        <Link
          to="/"
          className="p-10 text-[22px] font-extrabold uppercase tracking-[-0.02em] transition-opacity hover:opacity-70"
        >
          BALGYN
        </Link>
        <div className="flex flex-1 flex-col justify-end p-10">
          <p className="text-[40px] font-extrabold uppercase leading-[0.92] tracking-[-0.03em] text-white lg:text-[48px]">
      ...
      <div className="flex flex-1 flex-col bg-white">
        ...
        <div className="border-b border-[--color-border] px-5 py-5 md:hidden">
          <Link
            to="/"
            className="text-[20px] font-extrabold uppercase tracking-[-0.02em] text-black"
          >
            BALGYN
          </Link>
        </div>
